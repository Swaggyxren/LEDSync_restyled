...
class CachedAppInfo {
  ...
  factory CachedAppInfo.fromJson(Map<String, dynamic> j) => CachedAppInfo(
    name: j['name'],
    packageName: j['packageName'],
    iconBase64: j['iconBase64'],
  );

  factory CachedAppInfo.fromAppInfo(AppInfo a) => CachedAppInfo(
    name: a.name,
    packageName: a.packageName,
    iconBase64: (a.icon != null && a.icon!.isNotEmpty)
        ? base64Encode(a.icon!)
        : null,
  );
...
class _NotificationConfigScreenState extends State<NotificationConfigScreen> {
  ...
  Future<void> _init() async {
    ...
    if (raw != null && raw.isNotEmpty) {
      try {
        parsed = (jsonDecode(raw) as Map).map(
  ...
  Future<List<CachedAppInfo>> _loadCache(bool sys) async {
    ...
    try {
      return (jsonDecode(j) as List)
          .map((e) => CachedAppInfo.fromJson(e))
          .toList();
    } catch (_) {
      return [];
    }
                  ...
                  children: [
                    ...
                    _reloading
                        ? const Padding(
                            ...
                            child: M3LoadingUncontained(size: 20),
                          )
                        : IconButton(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Include system apps in LED effects',
                                  style: TextStyle(
                          ...
                          Switch(value: _showSystem, onChanged: _toggleSystem),
                        ],
                      ),
                    ),
                  ),
            ...
            child: FutureBuilder<DeviceConfig>(
              ...
              builder: (_, cfgSnap) {
                ...
                if (_apps.isEmpty && !_reloading) {
                  return const M3LoadingScreen(message: 'Loading apps…');
                }
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (_, i) =>
                            _appCard(cs, apps[i], effects, cfg.loopingPatterns),
                      ),
                    ),
                  ],
                );
                ...
                Container(
                  ...
                  child: DropdownButton<String?>(
                    ...
                    icon: Icon(
                      ...
                      color: hasPattern ? cs.onPrimaryContainer : cs.outline,
                      size: 16,
                    ),
                    items: [
