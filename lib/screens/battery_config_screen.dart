...
class _BatteryConfigScreenState extends State<BatteryConfigScreen> {
  ...
  Future<void> _loadPrefs() async {
    ...
    if (!mounted) return;
    setState(() {
      _lowEffect  = _resolveEffect(_nullIfEmpty(sp.getString(kLowName)),
          fallback: _defaultLowEffect,      cfg: cfg);
      _critEffect = _resolveEffect(_nullIfEmpty(sp.getString(kCritName)),
          fallback: _defaultCriticalEffect, cfg: cfg);
      _fullEffect = _resolveEffect(_nullIfEmpty(sp.getString(kFullName)),
          fallback: _defaultFullEffect,     cfg: cfg);
  ...
  String? _resolveEffect(String? chosen,
      {required String fallback, required DeviceConfig? cfg}) {
  ...
  Future<void> _save() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: const Text('Battery LED settings saved',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(children: [
        ...
        Container(
          color: cs.surface,
          padding: EdgeInsets.only(left: 4, right: 16, top: topPad + 4, bottom: 4),
          child: Row(children: [
            IconButton(
        ...
        Expanded(
          child: FutureBuilder<DeviceConfig?>(
            ...
            builder: (_, snap) {
              ...
              final cfg = snap.data;
              if (cfg == null) {
                return Center(child: Text('Device not supported',
        ...
        child: SizedBox(
          ...
          child: Stack(alignment: Alignment.center, children: [
            ...
            Column(mainAxisSize: MainAxisSize.min, children: [
              Text('$_battLevel%',
                  style: GoogleFonts.spaceGrotesk(
                    color: cs.onSurface, fontWeight: FontWeight.bold, fontSize: 28)),
              Text(
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Icon(icon,
              color: onTap != null ? cs.onSurface : cs.outline.withValues(alpha: 0.4),
              size: 18),
        ),
      ),
    );
      ...
      child: Padding(
        ...
        child: Row(children: [
          ...
          DropdownButton<String?>(
            value: value,
            hint: Text('None', style: TextStyle(color: cs.outline, fontSize: 12)),
            underline: const SizedBox(),
            dropdownColor: cs.surfaceContainerHigh,
            style: TextStyle(color: cs.onSurface, fontSize: 13),
            icon: Icon(Icons.keyboard_arrow_down_rounded, color: cs.outline, size: 18),
            items: [
