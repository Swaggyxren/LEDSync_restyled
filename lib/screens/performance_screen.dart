...
class _PerformanceScreenState extends State<PerformanceScreen>
  ...
  void _parseCpu(String raw) {
    final result = SystemStatsParser.parseCpu(raw, _prevIdle, _prevTotal);
    _prevIdle = result.prevIdle;
    _prevTotal = result.prevTotal;
    if (result.cpuPct > 0) {
      _cpuPct = result.cpuPct;
      _cpuHistory.add(_cpuPct);
  ...
  void _parseRam(String raw) {
    final result = SystemStatsParser.parseRam(raw);
    if (result.totalMb > 0) {
      _ramTotal = result.totalMb;
      _ramUsed = result.usedMb;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final ramFrac = _ramTotal > 0
        ? (_ramUsed / _ramTotal).clamp(0.0, 1.0)
        : 0.0;
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              const Spacer(),
                              Text(
                                '${_isWarming ? _warmMs : _steadyMs}ms interval',
                                style: TextStyle(
                                  color: cs.outline,
                                  fontSize: 10,
                                  fontFamily: 'monospace',
                          ...
                          SizedBox(
                            ...
                            child: CustomPaint(
                              painter: _SparklinePainter(
                                data: _cpuHistory,
                                color: cpuCol,
                                gridColor: cs.outlineVariant.withValues(
                                  alpha: 0.3,
                                ),
                                ...
                                ClipRRect(
                                  ...
                                  child: Stack(
                                    children: [
                                      ...
                                      FractionallySizedBox(
                                        widthFactor: (_battLevel / 100.0).clamp(
                                          0.0,
                                          1.0,
                                        ),
                                        child: Container(
  ...
  Widget _ramChip(ColorScheme cs, String label, String val, Color color) =>
      Expanded(
        child: Container(
